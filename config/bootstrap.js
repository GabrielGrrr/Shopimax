 ...
 *
 * Une fonction asynchrone de Bootstrap exécutée juste avant que l'appli ne soit liftée.
 * > Besoin de plus de flexibilité ?  Vous pouvez également faire ceci en créant un hook.
 *
 * Pour plus d'informations sur comment bootrsapper votre app, voir :
